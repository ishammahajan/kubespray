...
module "compute" {
  ...
  number_of_nfs_nodes_no_floating_ip           = var.number_of_nfs_nodes_no_floating_ip
  k8s_masters                                  = var.k8s_masters
  k8s_nodes                                    = var.k8s_nodes
  ...
  nfs_root_volume_size_in_gb                   = var.nfs_root_volume_size_in_gb
  nfs_volume_size_in_gb                        = var.nfs_volume_size_in_gb
